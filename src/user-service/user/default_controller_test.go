...
func TestDefaultController_PutUser(t *testing.T) {
	...
	t.Run("Valid user (expect 200)", func(t *testing.T) {
		...
		mockUserRepository.EXPECT().Update(mock.Anything).Return(&model.User{
			Id:       1,
	...
	t.Run("Unknown user (expect 404)", func(t *testing.T) {
		...
		mockUserRepository.EXPECT().Update(mock.Anything).Return(nil, errors.New(ErrorUserNotFound))
...
func TestDefaultController_DeleteUser(t *testing.T) {
	...
	t.Run("Unauthorized (expect 401)", func(t *testing.T) {
		...
		mockUserRepository.EXPECT().Delete(mock.Anything).Return(nil)
	...
	t.Run("Unknown user (expect 404)", func(t *testing.T) {
		...
		mockUserRepository.EXPECT().Delete(mock.Anything).Return(errors.New(ErrorUserDeletion))
