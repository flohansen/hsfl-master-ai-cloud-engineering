module github.com/akatranlp/hsfl-master-ai-cloud-engineering/book-service
...
replace github.com/akatranlp/hsfl-master-ai-cloud-engineering/user-service => ../user-service
