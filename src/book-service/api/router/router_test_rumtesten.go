...
func TestRouterDuta(t *testing.T) {
	...
	t.Run("/api/v1/products/:productid", func(t *testing.T) {
		...
		t.Run("should call GET handler", func(t *testing.T) {
			...
			productsController.
				EXPECT().
				GetBook(w, r.WithContext(context.WithValue(r.Context(), "productid", "1"))).
				Times(1)
		...
		t.Run("should call PUT handler", func(t *testing.T) {
			...
			productsController.
				EXPECT().
				PutBook(w, r.WithContext(context.WithValue(r.Context(), "productid", "1"))).
				Times(1)
		...
		t.Run("should call DELETE handler", func(t *testing.T) {
			...
			productsController.
				EXPECT().
				DeleteBook(w, r.WithContext(context.WithValue(r.Context(), "productid", "1"))).
				Times(1)
